...
int main()
{
    ...
    int choice;
    int maxDepth = 2; // change this for different search depth desired
   ...
   //alpha beta
      ...
      alphabeta_session.humanVsComputerAlphaBeta(maxDepth,1);
    }
    else if(choice==3)
    {
    ...
    {
      AIgame aiGame_session;
      aiGame_session.AlphaBetaVsAlphaBeta(maxDepth,1);
